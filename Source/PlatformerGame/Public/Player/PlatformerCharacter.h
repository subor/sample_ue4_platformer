...
private:
	...
	//all input(include game controller/pad/keyboard/mouse etc, should be transfered by RuyiSDK)
private:
	void InputStateChangeHandler(std::string topic, apache::thrift::TBase* msg);
	void InputConnectionChangeHandler(std::string topic, apache::thrift::TBase* msg);
