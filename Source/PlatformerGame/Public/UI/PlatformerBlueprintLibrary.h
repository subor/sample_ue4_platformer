...
class UPlatformerBlueprintLibrary : public UBlueprintFunctionLibrary
{
	...
	UFUNCTION(BlueprintCallable, Category = HUD, meta = (WorldContext = "WorldContextObject"))
	static void ShowWaitingPanel(class UObject* WorldContextObject, bool isShow);

#pragma region Ruyi SDK related
	UFUNCTION(BlueprintCallable, Category = HUD, meta = (WorldContext = "WorldContextObject"))
	static void RuyiSDKMangerSetHUD(class UObject* WorldContextObject, APlatformerHUD* HUD);

	UFUNCTION(BlueprintCallable, Category = HUD, meta = (WorldContext = "WorldContextObject"))
	static void RuyiSDKGetProfile(class UObject* WorldContextObject);

	UFUNCTION(BlueprintCallable, Category = HUD, meta = (WorldContext = "WorldContextObject"))
	static void RuyiSDKPostScoreToLeadboard(class UObject* WorldContextObject, int score);
